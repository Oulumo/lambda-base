...
public class AuthenticationResponse {
    ...
    String principalId;
    transient AuthenticationResponse.PolicyDocument policyDocumentObject;
    Map<String, Object> policyDocument;

    public AuthenticationResponse(String principalId, PolicyDocument policyDocumentObject) {
    ...
    public Map<String, Object> getPolicyDocument() {
        ...
        for (int i = 0; i < statements.length; i++) {
            ...
            AuthenticationResponse.Statement statement = statements[i];
    ...
    public static class PolicyDocument {
        ...
        public AuthenticationResponse.Statement[] getStatement() {
            statements.add(allowStatement);
            statements.add(denyStatement);
            return statements.toArray(new AuthenticationResponse.Statement[statements.size()]);
        }
        ...
        public void addStatement(AuthenticationResponse.Statement statement) {
        ...
        public static PolicyDocument getAllowOnePolicy(String region, String awsAccountId, String restApiId, String stage, HttpMethod method, String resourcePath) {
            AuthenticationResponse.PolicyDocument policyDocument = new AuthenticationResponse.PolicyDocument(region, awsAccountId, restApiId, stage);
        ...
        public static AuthenticationResponse.PolicyDocument getAllowAllPolicy(String region, String awsAccountId, String restApiId, String stage) {
